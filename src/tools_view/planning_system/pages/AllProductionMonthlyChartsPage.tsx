                      ...
                      <table className="w-full">
                        ...
                        >
                          ...
                          {chartData.map((item, index) => {
                            const dailyGap =
                              item.rencanaProduksi - item.actualProduksi;
                            const dailyAchievement =
                              item.rencanaProduksi > 0
                                ? (item.actualProduksi / item.rencanaProduksi) *
                                  100
                                : 0;
                          ...
                          {(() => {
                            const totalRencanaPcs = chartData.reduce(
                              (sum, item) => sum + item.rencanaProduksi,
                              0,
                            );
                            const totalActualPcs = chartData.reduce(
                              (sum, item) => sum + item.actualProduksi,
                              0,
                            );
                            const gap = totalRencanaPcs - totalActualPcs;
                            const achievement =
                              totalRencanaPcs > 0
                                ? (totalActualPcs / totalRencanaPcs) * 100
                                : 0;
