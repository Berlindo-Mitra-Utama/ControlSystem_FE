          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Internal Tools & Management</p>
              </div>
            </div>
            <Link to="/tools">
      ...
      <main className="container mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
            Platform internal untuk manajemen produksi, perencanaan, dan monitoring operasional harian.
          </p>
          <Link to="/tools">
            <Button
              size="lg"
        ...
        <div className="bg-gray-800/30 rounded-2xl p-8 max-w-3xl mx-auto text-center">
          <h3 className="text-xl font-bold text-white mb-4">Informasi Sistem</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div>
              <div className="text-2xl font-bold text-orange-400 mb-1">Secure</div>
      ...
      <footer className="border-t border-gray-800 bg-gray-900/50 py-6">
        <div className="container mx-auto px-6 text-center">
          <div className="flex items-center justify-center space-x-3 mb-2">
            ...
            <span className="font-semibold text-white">PT Berlindo</span>
          </div>
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Internal Production System. For authorized personnel only.
          </p>
        </div>
      </footer>
    </div>
